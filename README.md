![build](https://github.com/sebastiendfortier/jupyter-xemacs-proxy/workflows/build/badge.svg)
...
(incl. [jupyter-server-proxy](https://github.com/jupyterhub/jupyter-server-proxy), [jupyter-xemacs-proxy](https://github.com/sebastiendfortier/jupyter-xemacs-proxy) and [Xpra-HTML5](https://xpra.org/))
...
```
pip install git+https://github.com/sebastiendfortier/jupyter-xemacs-proxy.git
```
